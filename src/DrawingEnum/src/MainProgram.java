...
import algorithms.Arc;
import algorithms.DrawingEnumeration;
import algorithms.Edge;
import algorithms.EdgeList;
import algorithms.History;
import algorithms.IAlgorithmHooks;
import algorithms.Node;
import algorithms.PartialDrawing;
import algorithms.Vertex;
import algorithms.VertexList;

public class MainProgram implements IAlgorithmHooks {
	...
	public static void showHelp() {
		messageStream.println("Usage: (java) MainProgram [options] N M");
