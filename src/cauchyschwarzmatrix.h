...
public:
	...
	int size() const { return this->subFlagAlgebra->size(); }

	int subN() const { return this->_subN; }
	int subK() const { return this->_subK; }
	int subNlabelled() const { return this->_subNlabelled; }
	int subKlabelled() const { return this->_subKlabelled; }	
